<%-- 
    Document   : editar
    Created on : 28 dic 2022, 22:55:50
    Author     : alumno
--%>

<%@page import="Modelo.AfiliadosDAO"%>
<%@page import="Modelo.Afiliados"%>
...
<html>
    ...
    <body>        
        <div class="container" >
            <h1 class="text-center" >Editar informacion del afiliado</h1>
                <div class="row" >
                    <%
				...
				AfiliadosDAO  afiliado=new AfiliadosDAO();
				resultado=afiliado.mostrarAfiliado(mid);				
		    %>
                    <form class="p-5" method="POST" action="AfiliadosController?accion=actualizar">
                         <div class="mb-2">
                            <label for="id" class="form-label" >id</label>
                            <input type="text" class="form-control" id="id" name="id" readonly="true" value=<%=resultado.getIdAfiliados() %> >                          
                        </div> 
                        <div class="mb-2">
                        ...
                        <div class="mb-2">
                            <label for="localidad" class="form-label" >Nacionalidad</label>
                            <input type="text" class="form-control" id="nacionalidad" name="nacionalidad" value=<%=resultado.getNacionalidad() %>   >                          
                        </div> 
                          <div class="mb-2">
